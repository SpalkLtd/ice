...
func (c *candidateBase) copy() (Candidate, error) {
	return unmarshalCandidateWithID(c.ID(), c.Marshal())
}
...
func UnmarshalCandidate(raw string) (Candidate, error) {
	return unmarshalCandidateWithID("", raw)
}

// UnmarshalCandidate Parses a candidate from a string
// https://datatracker.ietf.org/doc/html/rfc5245#section-15.1
func unmarshalCandidateWithID(id, raw string) (Candidate, error) { //nolint:cyclop
